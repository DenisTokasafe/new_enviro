                        ...
                        <div class="tab-content" id="custom-content-below-tabContent">
                            <div class="col-12 col-md-6 col-sm-10 mb-2">
                                <div class="row ">
                                    ...
                                    <div class="col-sm-6 ">
                                        <input type="text" name="nama" value="{{old("nama") }}" class=" @error('nama') is-invalid @enderror form-control form-control-sm">
                                        @error('nama')
                                ...
                                <div class="row m-2 ">
                                    ...
                                    <div class="col-12 col-md-6 col-sm-10">
                                        <div class="row bg-brown">
                                            ...
                                            <div class="col-sm-6 ">
                                                <input type="text" name="alkalinity" value="{{old("alkalinity") }}" class=" @error('alkalinity') is-invalid @enderror form-control form-control-sm">
                                                @error('alkalinity')
                                                <span class="invalid-feedback">{{$message}}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="col-12 col-md-6 col-sm-10">
                                        <div class="row bg-brown">
                                            ...
                                            <div class="col-sm-6 ">
                                                <input type="text" name="odour" value="{{old("odour") }}" class=" @error('odour') is-invalid @enderror form-control form-control-sm">
                                                @error('odour')
                                                <span class="invalid-feedback">{{$message}}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="col-12 col-md-6 col-sm-10">
                                        <div class="row bg-brown">
                                            ...
                                            <div class="col-sm-6 ">
                                                <input type="text" name="taste" value="{{old("taste") }}" class=" @error('taste') is-invalid @enderror form-control form-control-sm">
                                                @error('taste')
                                                <span class="invalid-feedback">{{$message}}</span>
                                                @enderror
                                            </div>
                                ...
                                <div class="row m-2 ">
                                    ...
                                    <div class="col-12 col-md-6 col-sm-10">
                                        <div class="row ">
                                            ...
                                            <div class="col-sm-6 ">
                                                <input type="text" name="residual_chlorine" value="{{old("residual_chlorine") }}" class=" @error('residual_chlorine') is-invalid @enderror form-control form-control-sm">
                                ...
                                <div class="row m-2 ">
                                    ...
                                    <div class="col-12 col-md-4 col-sm-10">
                                        <div class="row ">
                                            ...
                                            <div class="col-sm-6 ">
                                                <input type="text" name="ammonia_n_nh3" value="{{old("ammonia_n_nh3") }}" class=" @error('ammonia_n_nh3') is-invalid @enderror form-control form-control-sm">
                                                @error('ammonia_n_nh3')
                                                <span class="invalid-feedback">{{$message}}</span>
                                                @enderror
                                            </div>
                            ...
                            <div class="tab-pane fade" id="custom-content-below-Dissolved" role="tabpanel" aria-labelledby="custom-content-below-Dissolved-tab">
                                <div class="row m-2 ">
                                    ...
                                    <div class="col-12 col-md-6 col-sm-10">
                                        <div class="row bg-brown">
                                            <label for="inputPassword" class="  col-sm-6  col-form-label">Tin (Sn)</label>
                                            <div class="col-sm-6 ">
                                                <input type="text" name="tin_sn" value="{{old("tin_sn") }}" class=" @error('tin_sn') is-invalid @enderror form-control form-control-sm">
                                                @error('tin_sn')
                                                <span class="invalid-feedback">{{$message}}</span>
                                                @enderror
                                            </div>
                                ...
                                <div class="row m-2 ">
                                    <div class="col-12 col-md-6 col-sm-10">
                                        <div class="row ">
                                            ...
                                            <div class="col-sm-6 ">
                                                <input type="text" name="aluminium_t_al" value="{{old("aluminium_t_al") }}" class=" @error('aluminium_t_al') is-invalid @enderror form-control form-control-sm">
                                    ...
                                    <div class="col-12 col-md-6 col-sm-10">
                                        <div class="row bg-brown">
                                            <label for="inputPassword" class="  col-sm-6  col-form-label">Arsenic (As)</label>
                                            <div class="col-sm-6 ">
                                                <input type="text" name="arsenic_t_as" value="{{old("arsenic_t_as") }}" class=" @error('arsenic_t_as') is-invalid @enderror form-control form-control-sm">
                                                @error('arsenic_t_as')
                                                <span class="invalid-feedback">{{$message}}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="col-12 col-md-6 col-sm-10">
                                        <div class="row bg-brown">
                                            ...
                                            <div class="col-sm-6 ">
                                                <input type="text" name="cadmium_t_cd" value="{{old("cadmium_t_cd") }}" class=" @error('cadmium_t_cd') is-invalid @enderror form-control form-control-sm">
                                                @error('cadmium_t_cd')
                                                <span class="invalid-feedback">{{$message}}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="col-12 col-md-6 col-sm-10">
                                        <div class="row bg-brown">
                                            ...
                                            <div class="col-sm-6 ">
                                                <input type="text" name="chromium_hexavalent_t_cr6" value="{{old("chromium_hexavalent_t_cr6") }}" class=" @error('chromium_hexavalent_t_cr6') is-invalid @enderror form-control form-control-sm">
                                    ...
                                    <div class="col-12 col-md-6 col-sm-10">
                                        <div class="row ">
                                            ...
                                            <div class="col-sm-6 ">
                                                <input type="text" name="chromium_t_cr" value="{{old("chromium_t_cr") }}" class=" @error('chromium_t_cr') is-invalid @enderror form-control form-control-sm">
                                                @error('chromium_t_cr')
                                                <span class="invalid-feedback">{{$message}}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="col-12 col-md-6 col-sm-10">
                                        <div class="row bg-brown">
                                            ...
                                            <div class="col-sm-6 ">
                                                <input type="text" name="cobalt_t_co" value="{{old("cobalt_t_co") }}" class=" @error('cobalt_t_co') is-invalid @enderror form-control form-control-sm">
                                                @error('cobalt_t_co')
                                                <span class="invalid-feedback">{{$message}}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="col-12 col-md-6 col-sm-10">
                                        <div class="row bg-brown">
                                            ...
                                            <div class="col-sm-6 ">
                                                <input type="text" name="copper_t_cu" value="{{old("copper_t_cu") }}" class=" @error('copper_t_cu') is-invalid @enderror form-control form-control-sm">
                                                @error('copper_t_cu')
                                                <span class="invalid-feedback">{{$message}}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="col-12 col-md-6 col-sm-10">
                                        <div class="row bg-brown">
                                            ...
                                            <div class="col-sm-6 ">
                                                <input type="text" name="lead_t_pb" value="{{old("lead_t_pb") }}" class=" @error('lead_t_pb') is-invalid @enderror form-control form-control-sm">
                                                @error('lead_t_pb')
                                                <span class="invalid-feedback">{{$message}}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="col-12 col-md-6 col-sm-10">
                                        <div class="row ">
                                            ...
                                            <div class="col-sm-6 ">
                                                <input type="text" name="selenium_t_se" value="{{old("selenium_t_se") }}" class=" @error('selenium_t_se') is-invalid @enderror form-control form-control-sm">
                                                @error('selenium_t_se')
                                                <span class="invalid-feedback">{{$message}}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="col-12 col-md-6 col-sm-10">
                                        <div class="row bg-brown">
                                            ...
                                            <div class="col-sm-6 ">
                                                <input type="text" name="mercury_t_hg" value="{{old("mercury_t_hg") }}" class=" @error('mercury_t_hg') is-invalid @enderror form-control form-control-sm">
                                                @error('mercury_t_hg')
                                                <span class="invalid-feedback">{{$message}}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="col-12 col-md-6 col-sm-10">
                                        <div class="row bg-brown">
                                            ...
                                            <div class="col-sm-6 ">
                                                <input type="text" name="nickel_t_ni" value="{{old("nickel_t_ni") }}" class=" @error('nickel_t_ni') is-invalid @enderror form-control form-control-sm">
                                                @error('nickel_t_ni')
                                                <span class="invalid-feedback">{{$message}}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="col-12 col-md-6 col-sm-10">
                                        <div class="row bg-brown">
                                            ...
                                            <div class="col-sm-6 ">
                                                <input type="text" name="zinc_t_zn" value="{{old("zinc_t_zn") }}" class=" @error('zinc_t_zn') is-invalid @enderror form-control form-control-sm">
                                                @error('zinc_t_zn')
                                                <span class="invalid-feedback">{{$message}}</span>
                                                @enderror
                                            </div>
                                ...
                                <div class="row m-2 ">
                                    ...
                                    <div class="col-12 col-md-6 col-sm-10">
                                        <div class="row ">
                                            ...
                                            <div class="col-sm-6 ">
                                                <input type="text" name="permanganate_number_as_kmno4" value="{{old("permanganate_number_as_kmno4") }}" class=" @error('permanganate_number_as_kmno4') is-invalid @enderror form-control form-control-sm">
                                    ...
                                    <div class="col-12 col-md-6 col-sm-10">
                                        <div class="row bg-brown">
                                            ...
                                            <div class="col-sm-6 ">
                                                <input type="text" name="benzene" value="{{old("benzene") }}" class=" @error('benzene') is-invalid @enderror form-control form-control-sm">
                                                @error('benzene')
                                                <span class="invalid-feedback">{{$message}}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="col-12 col-md-6 col-sm-10">
                                        <div class="row bg-brown">
                                            ...
                                            <div class="col-sm-6 ">
                                                <input type="text" name="chloroform" value="{{old("chloroform") }}" class=" @error('chloroform') is-invalid @enderror form-control form-control-sm">
                                                @error('chloroform')
                                                <span class="invalid-feedback">{{$message}}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="col-12 col-md-6 col-sm-10">
                                        <div class="row ">
                                            ...
                                            <div class="col-sm-6 ">
                                                <input type="text" name="2_4_6_trichloropenol" value="{{old("2_4_6_trichloropenol") }}" class=" @error('2_4_6_trichloropenol') is-invalid @enderror form-control form-control-sm">
                                    ...
                                    <div class="col-12 col-md-6 col-sm-10">
                                        <div class="row bg-brown">
                                            ...
                                            <div class="col-sm-6 ">
                                                <input type="text" name="2_4_d" value="{{old("2_4_d") }}" class=" @error('2_4_d') is-invalid @enderror form-control form-control-sm">
                                                @error('2_4_d')
                                                <span class="invalid-feedback">{{$message}}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="col-12 col-md-6 col-sm-10">
                                        <div class="row bg-brown">
                                            ...
                                            <div class="col-sm-6 ">
                                                <input type="text" name="pentachlorophenol" value="{{old("pentachlorophenol") }}" class=" @error('pentachlorophenol') is-invalid @enderror form-control form-control-sm">
                                    ...
                                    <div class="col-12 col-md-6 col-sm-10">
                                        <div class="row bg-brown">
                                            ...
                                            <div class="col-sm-6 ">
                                                <input type="text" name="total_pesticides" value="{{old("total_pesticides") }}" class=" @error('total_pesticides') is-invalid @enderror form-control form-control-sm">
                                    ...
                                    <div class="col-12 col-md-6 col-sm-10">
                                        <div class="row bg-brown">
                                            ...
                                            <div class="col-sm-6 ">
                                                <input type="text" name="chlordane_total_isomer" value="{{old("chlordane_total_isomer") }}" class=" @error('chlordane_total_isomer') is-invalid @enderror form-control form-control-sm">
                                    ...
                                    <div class="col-12 col-md-6 col-sm-10">
                                        <div class="row bg-brown">
                                            ...
                                            <div class="col-sm-6 ">
                                                <input type="text" name="dieldrin" value="{{old("dieldrin") }}" class=" @error('dieldrin') is-invalid @enderror form-control form-control-sm">
                                                @error('dieldrin')
                                                <span class="invalid-feedback">{{$message}}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="col-12 col-md-6 col-sm-10">
                                        <div class="row bg-brown">
                                            ...
                                            <div class="col-sm-6 ">
                                                <input type="text" name="aldrin" value="{{old("aldrin") }}" class=" @error('aldrin') is-invalid @enderror form-control form-control-sm">
                                                @error('aldrin')
                                                <span class="invalid-feedback">{{$message}}</span>
                                                @enderror
                                            </div>
