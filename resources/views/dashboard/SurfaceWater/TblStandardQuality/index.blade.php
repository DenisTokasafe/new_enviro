            ...
            <div class="card card-primary card-outline">
                <div class="card-header">
                    ...
                    <h3 class="card-title">
                        ...
                        <a href="#" class="btn bg-gradient-secondary btn-xs" data-toggle="modal" data-target="#modal-default">
                ...
                <div class="card-body">
                    <ul class="nav nav-tabs mb-2" id="custom-content-below-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="tab-physical-tab" data-toggle="pill" href="#tab-physical" role="tab text-dark">Physical-Chemical Standard</a>
                        </li>
                    </ul>
                                ...
                                <table class="table table-striped table-bordered table-sm text-center">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('standard-quality.edit', $item->id) }}" class="btn btn-outline-warning btn-xs">
                                                    <i class="fas fa-pen"></i>
                                                </a>
                                                <form action="{{ route('standard-quality.destroy', $item->id) }}" method="POST" class="d-inline">
                                                    @method('delete')
                                                    @csrf
