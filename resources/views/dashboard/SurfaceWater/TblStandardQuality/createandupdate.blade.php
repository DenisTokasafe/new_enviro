                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a
                                    href="{{ route('standard-quality.index') }}">{{ $tittle }}</a></li>
            ...
            <div class="container-fluid">
                <div class="card {{ $data->exists ? 'card-warning' : 'card-primary' }} card-outline">
                    ...
                    <div class="card-body">
                        ...
                        <form
                            action="{{ $data->exists ? route('standard-quality.update', $data->id) : route('standard-quality.store') }}"
                            ...
                            <div class="d-flex justify-content-end mt-4">
                                <a href="{{ route('standard-quality.index') }}"
                                    class="btn btn-secondary btn-xs mr-2">Back</a>
                                <button type="submit"
                                    class="btn {{ $data->exists ? 'btn-warning' : 'btn-primary' }} btn-xs">
