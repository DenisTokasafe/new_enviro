                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" step="0.01" name="tss_standard" 
                            ...
                            <div class="col-md-6 col-sm-12 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" step="0.01" name="ph_min_standard" 
                            ...
                            <div class="col-md-6 col-sm-12 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" step="0.01" name="ph_max_standard" 
                            ...
                            <div class="col-md-6 col-sm-12 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" step="0.01" name="do_standard" 
                            ...
                            <div class="col-md-6 col-sm-12 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" step="0.01" name="redox_standard" 
                            ...
                            <div class="col-md-6 col-sm-12 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" step="0.01" name="conductivity_standard" 
                            ...
                            <div class="col-md-6 col-sm-12 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" step="0.01" name="temperatur_standard" 
